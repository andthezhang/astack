...
- **Correction**: During compound, read commits since `.astack/last-sync`, explicitly review them for suspicious removals, and write the smallest durable follow-up before moving on.
